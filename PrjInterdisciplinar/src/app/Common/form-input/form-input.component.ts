...
export class FormInputComponent{
  ...
  @Input() errorValidators : string[] = []; //Tipos de erros para o campo
  ...
  */
  getErrorMessage(erro : string) : string{
    switch (erro) {
      ...
      case 'minlength':
        return `Deve ser maior do que ${this.formGroup.get(this.controlName)?.errors?.['minlength']?.requiredLength} caracteres`
