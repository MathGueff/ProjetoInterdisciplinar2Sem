...
export class NavbarComponent {
  ...
  links : NavbarLink[] =[
    ...
    {path: '/reclamacao-inicial', img: 'assets/icones/icon_white_reclamacao.svg', alt : 'Ícone do link para página de Reclamação', nome : 'Reclamação'},
    {path: '/doenca-detalhada', img: 'assets/icones/icon_white_noticia.svg', alt : 'Ícone do link para página de Notícias', nome : 'Teste'},
