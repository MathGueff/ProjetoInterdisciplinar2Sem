...
@Component({
  ...
  standalone: true,
  imports: [CommonModule,ComentarioCimaComponent,ComentarioBaixoComponent,ComentarioInputComponent,RouterModule],
...
export class ComentarioCentralComponent implements OnInit {
  ...
  private comentarioSubject:BehaviorSubject<Comentario[]> = new BehaviorSubject([] as any);
  ...
  ngOnInit(): void {
    this.activeroute.params.subscribe((params) =>{
      ...
      //Filtra todos os comentários de acordo com o ID da reclamação e retorna uma Array
      const comentario = this.comentarios.filter((comentario) => comentario.idReclamacao === IdParametro);
